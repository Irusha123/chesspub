...
jQuery(document).ready(function(){
    $('.topic').slideDown(3000);
    

    $('.chessitto').mousedown(function(){
        $('#plate').css('box-shadow', '0px 0px 300px #0f0');
        $('.topic').css('text-shadow', '0px 0px 100px #0f0');

    });

    $('.chessitto').mouseleave(function(){
        $('#plate').css('box-shadow', '0px 0px 200px #00f');
        $('.topic').css('text-shadow', '0px 0px 100px #0ff');
